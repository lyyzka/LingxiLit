export const DATABASE_CONFIG_NOT_FOUND = "不存在数据库配置！";
export const UNAUTHORIZED_USER = "未经授权的用户！";
export const FORBIDDEN_ACTION = "您没有执行此操作的权限。";
export const NO_ORGANISATION_SELECTED = "没有活跃的组织。切换组织以继续。";
export const ORGANISATION_CONTEXT_REQUIRED = "需要组织背景";
export const MALFORMED_INPUTS = "输入格式错误！请检查文档";
export const OPERATION_FAILED = "操作失败！";

// API Keys
export const NO_API_KEY = "不存在这样的 apiKey！";
export const MANAGE_API_KEYS = "管理 API 密钥";
export const OPENAI_SPEC = "OpenAPI 规范";
export const GENERATE_NEW_API_KEY = "Generate New API Key";
export const CREATE_NEW_KEY = "创建 API 密钥";
export const SETTINGS = "设置";
export const OPENAPI_SPECIFICATION = "OpenAPI 规范";
export const OPENAPI_SPECIFICATION_UI = "OpenAPI 规范 UI";
export const INTERACTIVE_API_REFERENCE = "Interactive API Reference";
export const OPENAPI_SPEC_BEARER_AUTH = "OpenAPI 3.0 规范 • Bearer 身份验证";
export const REQUEST_CURL_EXAMPLE = "请求 cURL 示例";
export const COPY_SNIPPET = "复制片段";
...
export const COPIED_TO_CLIPBOARD = "已复制到剪贴板！";

// Prompts
export const PROMPT_NAME_TAKEN = "提示名称已被占用！";
export const PROMPT_NOT_CREATED = "无法创建提示！";
export const PROMPT_SAVED = "提示保存成功！";
export const NO_PROMPT = "不存在或尚未发布此类提示！";
export const PROMPT_DELETED = "提示删除成功！";
export const PROMPT_NOT_DELETED = "删除提示时出错！";
export const VERSION_NOT_CREATED = "无法创建版本";
export const VERSION_NOT_SAVED = "版本无法保存";
export const VERSION_SAVED = "提示版本保存成功！";
...
export const EVALUATION_STAT_EVALUATIONS = "评价";
export const EVALUATION_STAT_ACTIVE = "活跃";
export const EVALUATION_STAT_TRACES_EVALUATED = "已评估追踪";
export const EVALUATION_STAT_EXECUTIONS = "执行次数";
export const EVALUATION_STAT_TOTAL_COST = "总成本";
export const EVALUATION_STAT_AVG_PASS_RATE = "平均通过率";
export const EVALUATION_STAT_FAILED_SCORES = "分数标记为不及格";
export const EVALUATION_STAT_AUTO_EXECUTIONS = "自动执行";
export const EVALUATION_STAT_EVALUATORS = "Evaluators";
export const EVALUATION_CHART_PASS_RATE = "通过率";
...
// Observability
export const OBSERVABILITY_TITLE = "观测";
export const OBSERVABILITY_TRACE_LOADING = "正在加载追踪…";
export const OBSERVABILITY_LOADING = "正在加载…";
export const OBSERVABILITY_TRACE_DETAILS = "追踪详情";
export const OBSERVABILITY_TRACES = "追踪";
export const OBSERVABILITY_EXCEPTIONS = "异常";
export const OBSERVABILITY_METRICS = "指标";
export const OBSERVABILITY_LOGS = "日志";
export const OBSERVABILITY_TRACE_SHORT_LABEL = "延迟、成本、Token";
export const OBSERVABILITY_EXCEPTION_SHORT_LABEL = "失败与错误跨度";
export const OBSERVABILITY_METRIC_SHORT_LABEL = "仪表、总和与直方图";
export const OBSERVABILITY_LOG_SHORT_LABEL = "事件与关联上下文";
export const OBSERVABILITY_TRACE_SUMMARY = "跨度流程";
export const OBSERVABILITY_EXCEPTION_SUMMARY = "失败路径";
export const OBSERVABILITY_METRIC_SUMMARY = "指标形态";
export const OBSERVABILITY_LOG_SUMMARY = "事件流";
export const OBSERVABILITY_BACK = "返回";
export const OBSERVABILITY_DURATION = "耗时";
export const OBSERVABILITY_TOKENS = "Tokens";
export const OBSERVABILITY_COST = "成本";
export const OBSERVABILITY_MODEL = "模型";
export const OBSERVABILITY_TRACE_ID = "Trace ID";
export const OBSERVABILITY_SPAN_ID = "Span ID";
export const OBSERVABILITY_SERVICE = "服务";
export const OBSERVABILITY_APPLICATION = "应用";
export const OBSERVABILITY_SYSTEM = "系统";
export const OBSERVABILITY_UNKNOWN_SERVICE = "未知服务";
export const OBSERVABILITY_UNKNOWN_APP = "未知应用";
export const OBSERVABILITY_PREVIOUS_SPAN = "上一个跨度";
export const OBSERVABILITY_NEXT_SPAN = "下一个跨度";
export const OBSERVABILITY_SPAN_ATTRIBUTES = "跨度属性";
export const OBSERVABILITY_RESOURCE_ATTRIBUTES = "资源属性";
export const OBSERVABILITY_SCOPE_ATTRIBUTES = "范围属性";
export const OBSERVABILITY_LOG_ATTRIBUTES = "日志属性";
export const OBSERVABILITY_METRIC_ATTRIBUTES = "指标属性";
export const OBSERVABILITY_RAW_RECORD = "原始记录";
export const OBSERVABILITY_RAW_LOG = "原始日志";
export const OBSERVABILITY_FIELD = "字段";
export const OBSERVABILITY_VALUE = "值";
export const OBSERVABILITY_TYPES = "类型";
export const OBSERVABILITY_MODELS = "模型";
export const OBSERVABILITY_PROVIDERS = "提供商";
export const OBSERVABILITY_MAX_COST = "最高成本";
export const OBSERVABILITY_APPLICATION_NAMES = "应用名称";
export const OBSERVABILITY_SPAN_NAMES = "跨度名称";
export const OBSERVABILITY_ENVIRONMENTS = "环境";
export const OBSERVABILITY_SERVICES = "服务";
export const OBSERVABILITY_SEVERITIES = "严重程度";
export const OBSERVABILITY_METRIC_NAMES = "指标名称";
export const OBSERVABILITY_METRIC_TYPES = "指标类型";
export const OBSERVABILITY_COPY_UNSUPPORTED =
	"Copy to clipboard is not supported in this browser";
export const OBSERVABILITY_LINK_COPIED = "链接已复制到剪贴板";
export const OBSERVABILITY_LINK_COPY_FAILED = "无法复制链接";
export const OBSERVABILITY_COPY_SHARE_LINK = "复制分享链接";
...
export const OBSERVABILITY_TIME = "时间";
export const OBSERVABILITY_SEVERITY = "严重程度";
export const OBSERVABILITY_BODY = "内容";
export const OBSERVABILITY_METRIC = "指标";
export const OBSERVABILITY_TYPE = "类型";
export const OBSERVABILITY_UNIT = "单位";
export const OBSERVABILITY_LATEST = "最新";
export const OBSERVABILITY_POINTS = "数据点";
export const OBSERVABILITY_LAST_SEEN = "最后出现时间";
export const OBSERVABILITY_LOG_ENTRY = "日志条目";
export const OBSERVABILITY_LATEST_METRIC_ATTRIBUTES =
	"最新指标属性";
export const OBSERVABILITY_LATEST_RESOURCE_ATTRIBUTES =
	"最新资源属性";
export const OBSERVABILITY_LATEST_SCOPE_ATTRIBUTES = "最新范围属性";
export const OBSERVABILITY_LATEST_METRIC_POINT = "最新指标数据点";
export const OBSERVABILITY_LOADED_POINTS = "已加载数据点";
export const OBSERVABILITY_CLOSE = "关闭";
export const OBSERVABILITY_FIELDS = "字段";
export const OBSERVABILITY_LOG_ATTRS = "日志属性";
export const OBSERVABILITY_RESOURCE = "资源";
export const OBSERVABILITY_SCOPE = "范围";
export const OBSERVABILITY_RAW = "原始数据";
export const OBSERVABILITY_AUTO = "自动";
export const OBSERVABILITY_METRIC_POINTS = "指标数据点";
export const OBSERVABILITY_LOG_EVENTS = "日志事件";
export const OBSERVABILITY_SPANS = "跨度";
export const OBSERVABILITY_FRESHNESS_LIVE = "实时";
export const OBSERVABILITY_FRESHNESS_SAMPLED = "采样";
export const OBSERVABILITY_FRESHNESS_ACCELERATED = "加速";
export const OBSERVABILITY_TOTAL = "总计";
export const OBSERVABILITY_PEAK = "峰值";
export const OBSERVABILITY_SPAN_HIERARCHY = "跨度层级";
export const OBSERVABILITY_LOADING_SPANS = "正在加载跨度";
...
export const OBSERVABILITY_TREE = "树状图";
export const OBSERVABILITY_CHAT = "对话";
export const OBSERVABILITY_CHAT_FILTER_CONVERSATION = "当前对话";
export const OBSERVABILITY_CHAT_FILTER_ALL = "所有活动";
...
export const OBSERVABILITY_TIMELINE = "时间线";
export const OBSERVABILITY_GRAPH = "图表";
export const OBSERVABILITY_NO_SERVER_CONNECTION = "无法连接到服务器！";
export const OBSERVABILITY_ADD = "添加";
...
export const OBSERVABILITY_FULL_SCREEN = "全屏";
export const OBSERVABILITY_EVALUATION_PANEL = "评估";
export const OBSERVABILITY_ROW = "行";
export const OBSERVABILITY_TRACE = "追踪";
export const OBSERVABILITY_SPAN = "跨度";
export const OBSERVABILITY_SCOPE_META = "范围";
...
export const SIDEBAR_MONITOR = "观测";
export const SIDEBAR_DEVELOP = "开发";
export const SIDEBAR_CONFIGURATION = "配置";
export const SIDEBAR_PROJECTS = "项目";

// Agents
export const AGENTS_FILTER_SYSTEM = "系统";
export const AGENTS_FILTER_PROVIDER = "提供商";
export const AGENTS_FILTER_STATUS = "状态";
export const AGENTS_FILTER_STATUS_DISCOVERED = "已发现";
export const AGENTS_FILTER_STATUS_INSTRUMENTED = "已接入观测";
export const AGENTS_FILTER_CONTROLLER_HEALTH = "健康状态";
export const AGENTS_FILTER_CONTROLLER_ACTIVE = "活跃";
export const AGENTS_FILTER_CONTROLLER_HEALTHY = "健康";
export const AGENTS_FILTER_CONTROLLER_DEGRADED = "降级";
export const AGENTS_FILTER_CONTROLLER_STALE = "过期";
export const AGENTS_FILTER_CONTROLLER_ERROR = "错误";
export const AGENTS_CLEAR_FILTERS = "清除筛选";
export const AGENTS_APPLY_FILTERS = "应用筛选";
...
export const AGENTS_STAT_CONTROLLERS = "活跃控制器";
export const AGENTS_STAT_DISCOVERED_SERVICES = "已发现智能体";
export const AGENTS_STAT_INSTRUMENTED_SERVICES = "已接入观测的智能体";
export const AGENTS_STAT_CODING_VENDORS = "编码智能体总数";
export const AGENTS_STAT_CODING_COST = "总成本";
export const AGENTS_STAT_CODING_USERS = "用户总数";
export const AGENTS_TAB_SERVICES = "应用";
export const AGENTS_TAB_CONTROLLERS = "控制器";
export const AGENTS_TAB_CODING = "编码智能体";
export const AGENTS_ADD_CONTROLLER = "添加控制器";
export const AGENTS_ADD_CODING_AGENT = "添加编码智能体";
...
export const AGENTS_NO_CONTROLLERS_TITLE = "未检测到控制器";
...
export const AGENTS_API_KEY_RECOMMENDED_PREFIX = "建议：";
export const AGENTS_API_KEY_RECOMMENDED_BEFORE_LINK = "请在以下位置创建 API 密钥：";
...
export const AGENTS_COPY_TO_CLIPBOARD = "复制到剪贴板";

// Agents - Service Table
export const AGENTS_SERVICE_PID_PREFIX = "PID";
export const AGENTS_SERVICE_ACTION_DISABLING = "正在禁用…";
export const AGENTS_SERVICE_ACTION_ENABLING = "正在启用…";
export const AGENTS_SERVICE_ACTION_WORKING = "正在处理…";
export const AGENTS_SERVICE_ACTION_DISABLE = "禁用";
export const AGENTS_SERVICE_ACTION_ENABLE = "启用";
export const AGENTS_SERVICE_ACTION_ELLIPSIS = "...";
export const AGENTS_SERVICE_MANUAL_BADGE = "手动";
...
export const AGENTS_COLUMN_SERVICE = "名称";
export const AGENTS_COLUMN_SYSTEM = "系统";
export const AGENTS_COLUMN_RUNTIME = "运行时";
export const AGENTS_COLUMN_PROVIDERS = "提供商";
...
export const AGENTS_CODING_USERS_WINDOW_LABEL = "活跃用户";
export const AGENTS_CODING_COST_WINDOW_LABEL = "成本（USD）";
export const AGENTS_CODING_COLUMN_VENDOR = "厂商";
export const AGENTS_CODING_COLUMN_SESSIONS = "会话";
export const AGENTS_CODING_COLUMN_USERS = "用户";
export const AGENTS_CODING_COLUMN_COST = "成本";
export const AGENTS_CODING_COLUMN_LINES = "代码行数";
export const AGENTS_CODING_COLUMN_ACCEPTANCE = "采纳率";
export const AGENTS_CODING_COLUMN_COMMITS = "提交";
export const AGENTS_CODING_COLUMN_PRS = "拉取请求";
export const AGENTS_CODING_EMPTY_TITLE = "暂无编码智能体";
